...
namespace TaskStorm.Migrations
{
    ...
    [Migration("20260517144957_Notifications")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IssueLabels", b =>
                {
                    ...
                    b.Property<int>("MasterdataValueId")
                        .HasColumnType("integer")
                        .HasColumnName("masterdata_value_id");

                    b.HasKey("IssueId", "MasterdataValueId")
                        .HasName("pk_issue_labels");

                    b.HasIndex("MasterdataValueId")
                        .HasDatabaseName("ix_issue_labels_masterdata_value_id");

                    b.ToTable("issue_labels", "public");
                });
            ...
            modelBuilder.Entity("TaskStorm.Event.Notification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<int>("EventAuthorId")
                        .HasColumnType("integer")
                        .HasColumnName("event_author_id");
            ...
            modelBuilder.Entity("TaskStorm.Model.Entity.Activity", b =>
                {
                    ...
                    b.Property<string>("MasterDataCode")
                        .HasColumnType("text")
                        .HasColumnName("master_data_code");
            ...
            modelBuilder.Entity("TaskStorm.Model.Entity.Masterdata.MasterdataValue", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_masterdata_values");

                    b.HasIndex("Type", "Code")
                        .IsUnique()
                        .HasDatabaseName("ix_masterdata_values_type_code");

                    b.ToTable("masterdata_values", "public");
                });
            ...
            modelBuilder.Entity("IssueLabels", b =>
                {
                    b.HasOne("TaskStorm.Model.IssueFolder.Issue", null)
                        .WithMany()
                    ...
                    b.HasOne("TaskStorm.Model.Entity.Masterdata.MasterdataValue", null)
                        .WithMany()
                        .HasForeignKey("MasterdataValueId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_issue_labels_masterdata_values_masterdata_value_id");
                });
